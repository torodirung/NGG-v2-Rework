...
public OnPlayerLoad(playerid)
{
	...
	SendClientMessageEx(playerid, COLOR_WHITE, string);
	SendClientMessageEx( playerid, COLOR_WHITE, "[-] {FA0000}C{FFFFFF}ong {FA0000}D{FFFFFF}ong CLBSAMP -{A0A1A3} "SERVER_GM_TEXT"");
 	SendClientMessageEx( playerid, COLOR_WHITE, "[-] {FF0000}LUU Y{FFFFFF}: Hay tu minh viet mot kich ban hap dan nhat!" );
 	SendClientMessageEx( playerid, COLOR_WHITE, "[-] {7DAFFF}/newb{A0A1A3} [noidungcauhoi]{FFFFFF} de hoi van de ban chua biet!" );
 	SendClientMessageEx( playerid, COLOR_WHITE, "[-] Ban co the {FF0000}/yeucautrogiup{FFFFFF}de truc tiep yeu cau ho tro vien giup do!" );
 	SendClientMessageEx( playerid, COLOR_YELLOW, "Download Gamemode tai clbsamp.cf" );
